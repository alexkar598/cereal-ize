...
/datum/josn/var/list/JSON_migratable_versions | N/A | list of versions to call Migrate() on, not required for migrations defined via JSON_MIGRATION(). Defaults to null
